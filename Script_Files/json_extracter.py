...
def extract_highest_confidence_midpoints_from_folder(folder_path, output_csv, conf_threshold, video_metadata_csv, bbox_metadata_csv,frames_per_second=30):
...
if __name__ == "__main__":
    ...
    extract_highest_confidence_midpoints_from_folder(args.json_folder, args.output_csv, args.confidence_threshold, args.video_metadata_csv, args.bbox_metadata_csv, frames_per_second=args.frames_per_second)
